...
public class Tetrimino2 implements Shape {
    ...
    public Tetrimino2() {
        this.nTiles = 4;
        this.fillColor = new Color(0, 0, 240);
        this.borderColor = new Color(179, 179, 251);
        this.currentRotationIndex = 0;
        this.rotation = new Point2D[Tetrimino2.N_ROTATIONS][this.nTiles];
    ...
    public void rotateRigth() {
        this.currentRotationIndex = (this.currentRotationIndex + 1) % Tetrimino2.N_ROTATIONS;
    }

    public void rotateLeft() {
        this.currentRotationIndex = (Tetrimino2.N_ROTATIONS + this.currentRotationIndex - 1) % Tetrimino2.N_ROTATIONS;
    }
